 ...
 */
public class PicassoDisplayOtherImages extends AppCompatActivity {

    public static final int PERMISSION_WRITE = 0;
    ImageView imageView;
    Button back_icon, save, share, wallpaper, DownloadView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        back_icon = findViewById(R.id.button_back_other_images);
        ...
        imageView = findViewById(R.id.image_display_other_images);
        ...
        wallpaper = findViewById(R.id.button_wallpaper_other_images);
        ...
        share = findViewById(R.id.button_share_other_images);
        ...
        save = findViewById(R.id.button_download_other_images);
    ...
    public void ShowcaseView() {
        ...
        DownloadView = findViewById(R.id.download_view_other_images);
        sequence.addSequenceItem(DownloadView,
    ...
    public void saveMyImage(String appName, String imageUrl, String imageName) {
        ...
        try {
            ...
            Toasty.normal(getApplicationContext(), "تم حفظ الصورة في مجلد تطبيق المؤمن", Toast.LENGTH_SHORT).show();
