 ...
 */
public class ImagesOthersActivity extends AppCompatActivity implements Picasso.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Picasso(this, OthersImages);
        adapter.setClickListener(this);
        recyclerView.setAdapter(adapter);
        // change the adapter at random
        Collections.shuffle(Arrays.asList(OthersImages));
    ...
    public void ArrayListImages() {
        // ArrayList for Others Images
        OthersImages = new String[]{
                // 1
