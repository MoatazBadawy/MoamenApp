...
/*
 * This class for display aqsa images
 */
public class ImagesAqsaActivity extends AppCompatActivity implements Picasso.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Picasso(this, AqsaImages);
        adapter.setClickListener(this);
        recyclerView.setAdapter(adapter);
        // change the adapter at random
        Collections.shuffle(Arrays.asList(AqsaImages));
