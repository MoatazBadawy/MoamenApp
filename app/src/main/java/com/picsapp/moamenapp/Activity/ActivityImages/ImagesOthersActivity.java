...
public class ImagesOthersActivity extends AppCompatActivity implements Picasso.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.images_activity_others);
        ...
        RecyclerView recyclerView = findViewById(R.id.recyclerview_image_others);
        ...
        AdView mAdView = findViewById(R.id.adViewOthers);
