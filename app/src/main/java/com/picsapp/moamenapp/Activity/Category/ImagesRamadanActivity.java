...
/*
 * This class for display the ramadan images
 */
public class ImagesRamadanActivity extends AppCompatActivity implements Picasso.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Picasso(this, RamadanImages);
        adapter.setClickListener(this);
        recyclerView.setAdapter(adapter);
        // change the adapter at random
        Collections.shuffle(Arrays.asList(RamadanImages));
    ...
    public void ArrayListImages() {
        // ArrayList for Ramadan Images
        RamadanImages = new String[]{
                // 1
