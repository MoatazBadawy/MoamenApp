...
public class ImagesRamadanActivity extends AppCompatActivity implements Picasso.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_images_ramadan);
        ...
        RecyclerView recyclerView = findViewById(R.id.recyclerview_image_ramadan);
    ...
    public void Ads() {
        ...
        AdView mAdView = findViewById(R.id.adViewRamadan);
