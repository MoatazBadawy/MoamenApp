...
public class ImagesMoqAlaramActivity extends AppCompatActivity implements Picasso.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.images_activity_moq_al_haram);
        ...
        // ArrayList for MoqAlHaram Images
        ...
        RecyclerView recyclerView = findViewById(R.id.recyclerview_image_haram);
