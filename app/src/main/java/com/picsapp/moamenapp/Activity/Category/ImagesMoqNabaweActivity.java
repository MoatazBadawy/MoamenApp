 ...
 */
public class ImagesMoqNabaweActivity extends AppCompatActivity implements Picasso.ItemClickListener {

    String[] MoqAlNabaweImages;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Picasso(this, MoqAlNabaweImages);
        adapter.setClickListener(this);
        recyclerView.setAdapter(adapter);
        // change the adapter at random
        Collections.shuffle(Arrays.asList(MoqAlNabaweImages));
    ...
    public void onItemClick(View view, int position) {
        // get the image
        String image = MoqAlNabaweImages[position];
