package com.picsapp.moamenapp.Activity.Category;
...
import com.picsapp.moamenapp.Fragment.Images.HomeImagesFragment;
...
/*
 * This class for display Morning images
 */
public class ImagesMorningActivity extends AppCompatActivity implements Picasso.ItemClickListener {

    String[] MorningImages;
    private Picasso adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_images_categorys);
        ...
        RecyclerView recyclerView = findViewById(R.id.recyclerview_image_aqsa);
        ...
        adapter = new Picasso(this, MorningImages);
        adapter.setClickListener(this);
        recyclerView.setAdapter(adapter);
        // change the adapter at random
        Collections.shuffle(Arrays.asList(MorningImages));
    ...
    public void ArrayListImages() {
        // ArrayList for Morning Images
        MorningImages = new String[]{
                // 1
