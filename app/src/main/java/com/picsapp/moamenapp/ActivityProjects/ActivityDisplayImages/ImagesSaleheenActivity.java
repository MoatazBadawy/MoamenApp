 ...
 */
public class ImagesSaleheenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button back_icon = findViewById(R.id.button_back6);
        ...
        final ProgressBar
                progressBar_images = findViewById(R.id.loading_indicator4);
        ...
        /* ArrayList for SalehenImages */
        final String[] SaleheenImages = {
                "https://www.mexatk.com/wp-content/uploads/2017/07/%D8%A7%D8%AF%D8%B9%D9%8A%D8%A9-%D8%AF%D9%8A%D9%86%D9%8A%D8%A9-3.jpg",
                "https://www.mexatk.com/wp-content/uploads/2017/07/%D8%A7%D8%AF%D8%B9%D9%8A%D8%A9-%D8%AF%D9%8A%D9%86%D9%8A%D8%A9-3.jpg",
        ...
        GridView gridView = findViewById(R.id.gridview_image_saleheen);
        // display all the images from Array on it
        gridView.setAdapter(new PicassoImagesAdapter(ImagesSaleheenActivity.this, SaleheenImages));
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ImagesSaleheenActivity.this, PicassoDisplayImageAdapter.class);
                intent.putExtra("imageUrl", image);
                ImagesSaleheenActivity.this.startActivity(intent);
            }
        });
