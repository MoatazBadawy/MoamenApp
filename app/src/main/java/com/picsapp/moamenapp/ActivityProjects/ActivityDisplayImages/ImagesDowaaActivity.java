...
/*
 * This class for display All images
 */
public class ImagesDowaaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridView gridView = findViewById(R.id.gridview_image_dowaa);
        // Add all images in gridView
        gridView.setAdapter(new PicassoImagesAdapter(ImagesDowaaActivity.this, DowaaImages));
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ImagesDowaaActivity.this, PicassoDisplayImageAdapter.class);
                intent.putExtra("imageUrl", image);
                ImagesDowaaActivity.this.startActivity(intent);
            }
        });
