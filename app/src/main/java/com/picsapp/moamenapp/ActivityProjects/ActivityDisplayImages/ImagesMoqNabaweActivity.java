 ...
 */
public class ImagesMoqNabaweActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mages_mosq_nabawe);
        ...
        /* ArrayList for MoqAlNabaweImages */
        final String[] MoqAlNabaweImages = {
        ...
        GridView gridView = findViewById(R.id.gridview_image_nabawe);
        // display all the images from Array on it
        gridView.setAdapter(new PicassoImagesAdapter(ImagesMoqNabaweActivity.this, MoqAlNabaweImages));
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ImagesMoqNabaweActivity.this, PicassoDisplayImageAdapter.class);
                intent.putExtra("imageUrl", image);
                ImagesMoqNabaweActivity.this.startActivity(intent);
            }
        });
