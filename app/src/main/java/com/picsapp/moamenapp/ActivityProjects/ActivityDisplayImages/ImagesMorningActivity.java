...
public class ImagesMorningActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button back_icon = findViewById(R.id.button_back_morning);
        ...
        final ProgressBar
                progressBar_images = findViewById(R.id.loading_image_morning);
        ...
        /* ArrayList for MorningImages */
        final String[] MorningImages = {
        ...
        GridView gridView = findViewById(R.id.gridview_image_morning);
        // display all the images from Array on it
        gridView.setAdapter(new PicassoImagesAdapter(ImagesMorningActivity.this, MorningImages));
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ImagesMorningActivity.this, PicassoDisplayImageAdapter.class);
                intent.putExtra("imageUrl", image);
                ImagesMorningActivity.this.startActivity(intent);
            }
        });
