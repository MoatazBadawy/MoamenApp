 ...
 */
public class ImagesMoqAlaramActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button back_icon = findViewById(R.id.button_back2);
        ...
        final ProgressBar
                progressBar_images = findViewById(R.id.loading_indicator6);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                // get the image
                String image = MoqAlHaramImages[position];
                Intent intent = new Intent(ImagesMoqAlaramActivity.this, PicassoDisplayImageAdapter.class);
                intent.putExtra("imageUrl", image);
                ImagesMoqAlaramActivity.this.startActivity(intent);
            }
        });
