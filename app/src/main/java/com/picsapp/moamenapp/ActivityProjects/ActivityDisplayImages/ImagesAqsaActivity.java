 ...
 */
public class ImagesAqsaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* ArrayList for aqsaImages */
        final String[] AqsaImages = {
        ...
        GridView gridView = findViewById(R.id.gridview_image_aqsa);
        // display all the images from Array on it
        gridView.setAdapter(new PicassoImagesAdapter(ImagesAqsaActivity.this, AqsaImages));
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ImagesAqsaActivity.this, PicassoDisplayImageAdapter.class);
                intent.putExtra("imageUrl", image);
                ImagesAqsaActivity.this.startActivity(intent);
            }
        });
